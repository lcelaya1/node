...
const icons: Record<IconName, React.ReactNode> = {
  ...
  Done: (
    <path d="M6 13.5333L8.8 16.3333L18.1333 7" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
  ),
  Eye: (
  ...
  SquarePen: (
    <>
      ...
      />
      <path
        d="M18.375 2.625C18.7728 2.22717 19.3124 2.00368 19.875 2.00368C20.4376 2.00368 20.9772 2.22717 21.375 2.625C21.7728 3.02282 21.9963 3.56239 21.9963 4.125C21.9963 4.68761 21.7728 5.22717 21.375 5.625L12.362 14.639C12.1245 14.8762 11.8312 15.0499 11.509 15.144L8.636 15.984C8.54995 16.0091 8.45874 16.0106 8.37191 15.9884C8.28508 15.9661 8.20583 15.9209 8.14244 15.8576C8.07906 15.7942 8.03389 15.7149 8.01164 15.6281C7.9894 15.5413 7.9909 15.45 8.016 15.364L8.856 12.491C8.95052 12.169 9.12453 11.8761 9.362 11.639L18.375 2.625Z"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
