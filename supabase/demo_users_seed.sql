...
insert into public.demo_users (seed_user_id, name, age, city, bio, friends_count, plans_created, plans_done, avatar_url) values
  (1, 'Sofia', 27, 'Barcelona', 'Design student on a quest for BCN''s best coffee. Passionate about art, cinema, and meeting people who challenge my perspective.', 6, 2, 15, 'https://wjohtvugahrzjkgydwxk.supabase.co/storage/v1/object/public/avatars/Hike%20in%20Barcelona%20at%20Sunset.jpeg'),
  (2, 'Marcos', 24, 'Barcelona', 'Architecture grad with a soft spot for rooftops and record stores. Always planning the next trip.', 5, 5, 9, 'https://wjohtvugahrzjkgydwxk.supabase.co/storage/v1/object/public/avatars/At%20Hergett.jpeg'),
  (3, 'Lucía', 29, 'Barcelona', 'Marketing creative who lives for long dinners and spontaneous plans. Cocktails always involved.', 7, 8, 22, 'https://wjohtvugahrzjkgydwxk.supabase.co/storage/v1/object/public/avatars/_%20(20).jpeg')
